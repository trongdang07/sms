...
══════════════════════════════════════════════════════════
 ...
 => Zalo Admin: 0325676804
 => Facebook Admin: letronghaidang.limited 
╚════════════════════════════════════════════════════════╝
"""[1:]
...
print(Colorate.Diagonal(Colors.red_to_yellow, f"""=> Link Key: {link_key} """))
keynhap = Write.Input("=> Enter Key: ", Colors.red_to_yellow, interval=0.005)
if keynhap == key:
...
def oldpops(phone):
    ...
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] POPS: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] POPS: THẤT BẠI!"""))
...
def oldtv360(phone):
    ...
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] TV360: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] TV360: THẤT BẠI!"""))
...
def oldloship(phone):
    ...
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] LOSHIP: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] LOSHIP: THẤT BẠI!"""))
...
def oldalfrescos(phone):
    ...
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] ALFRESCOS: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] ALFRESCOS: THẤT BẠI!"""))
...
def oldfptshop(phone):
    ...
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] FPTSHOP: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] FPTSHOP: THẤT BẠI!"""))
...
def oldfacebook(phone):
    ...
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] FACEBOOK: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] FACEBOOK: THẤT BẠI!"""))
...
def oldzalopay(phone):
    ...
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] ZALOPAY: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] ZALOPAY: THẤT BẠI!"""))
# New Api Filter
...
def vieon(phone):
    ...
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] VIEON: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] VIEON: THẤT BẠI!"""))
...
def ahamove(phone):
    ...
    if Response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] AHAMOVE: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] AHAMOVE: THẤT BẠI!"""))
...
def concung(phone):
    ...
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] CONCUNG: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] CONCUNG: THẤT BẠI!"""))
...
def vietid(phone):
    ...
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] VIETID: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] VIETID: THẤT BẠI!"""))
...
def fptplay(phone):
    ...
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] FPTPLAY: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] FPTPLAY: THẤT BẠI!"""))
...
def funring(phone):
    ...
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] FUNRING: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] FUNRING: THẤT BẠI!"""))
...
def gotadi(phone):
    ...
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] GOTADI: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] GOTADI: THẤT BẠI!"""))

def winmart(phone):
    response = requests.get(f"https://api-crownx.winmart.vn/as/api/web/v1/send-otp?phoneNo={phone}")
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] WINMART: THÀNH CÔNG!"""))
    else:
...
def daihocfpt(phone):
    ...
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] DAIHOCFPT: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] DAIHOCFPT: THẤT BẠI!"""))
...
def cafeland(phone):
    ...
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] CAFELAND: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] CAFELAND: THẤT BẠI!"""))
...
def oldvayvnd(phone):
    ...
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] VAYVND: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] VAYVND: THẤT BẠI!"""))
...
def oldtamo(phone):
    ...
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] TAMO: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] TAMO: THẤT BẠI!"""))
...
def oldsenmo(phone):
    ...
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] SENMO: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] SENMO: THẤT BẠI!"""))
...
def thantaioi(phone):
    ...
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] THANTAIOI: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] THANTAIOI: THẤT BẠI!"""))
...
def atmonline(phone):
    ...
    if response.status_code == 200:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[*] ATMONLINE: THÀNH CÔNG!"""))
    else:
        print(Colorate.Diagonal(Colors.red_to_yellow, f"""[x] ATMONLINE: THẤT BẠI!"""))
...
def Main():
    ...
    Banner()
    while True:
        phone = Write.Input("=> NHẬP SỐ ĐIỆN THOẠI CẦN SPAM: ", Colors.red_to_yellow, interval=0.005)
        if phone in listsdt:
            print(Colorate.Diagonal(Colors.red_to_yellow, f"""=> BỐ MÀY LÀ ADMIN, MÀY THÍCH SPAM KHÔNG CON CHÓ?"""))
        else:
            if len(phone) == 10:
                break
            else:
